...
#LETRA C
if litronecessario > 10.8:
    qtdlata = litronecessario/litrolata
    litroresto = litronecessario % litrolata
    qtdgalaoresto = litroresto/litrogalao
    ...
    print('Visando menor valor, é recomendado comprar:', math.ceil(qtdgalao), 'galões de tinta, pelo total de R$:', preçopagogalao)